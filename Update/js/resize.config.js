// Iniciando biblioteca
        ...
        function redimensionar200()
        {
            ...
            // Redimensionando
            resize.photo(imagens[imagem_atual], 200, 'dataURL', function (imagem) {
        ...
        function redimensionar600()
        {
            ...
            resize.photo(imagens[imagem_atual], 600, 'dataURL', function (imagem) {
                ...
                // Salvando imagem no servidor
                $.post('ajax/guardar600.php', {imagem: imagem}, function() {
