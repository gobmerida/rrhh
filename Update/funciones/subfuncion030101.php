...
if($comprobarfecha<1){
echo "<a onclick='editarNoticiaMes(\"$id\")' style='cursor:pointer'>Editar</a>";
}
...
?>
<script>
function editarNoticiaMes(id) {
datos="funciones/subfuncion0302.php?noticia=" + id;
