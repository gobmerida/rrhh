...
$notiCount=0;
$printer="ver_noticias";
$noticiasROW = mysql_fetch_array($noticiaSQL);
	$id = $noticiasROW['id'];
	$nocache=md5(date("Y-m-s H:i:s"));
	echo "
<p style='float:right'><a onclick='editarNoticia(\"$id\")' style='cursor:pointer'>Editar</a><a onclick=\"ThumNoticesOc()\" style='cursor:pointer'>volver</a></p>
