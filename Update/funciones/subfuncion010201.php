...
$noticiasROW = mysql_fetch_array($noticiaSQL);
	...
	echo "
<p style='float:right'><a onclick='editarNoticia(\"$id\")' style='cursor:pointer'>Editar</a><a onclick=\"$('#trabajador_c').css('display','none');$('#ingreso_noticia').fadeIn(200)\" style='cursor:pointer'>volver</a></p>
